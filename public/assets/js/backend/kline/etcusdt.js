define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'kline/etcusdt/index' + location.search,
                    add_url: 'kline/etcusdt/add',
                    edit_url: 'kline/etcusdt/edit',
                    del_url: 'kline/etcusdt/del',
                    multi_url: 'kline/etcusdt/multi',
                    import_url: 'kline/etcusdt/import',
                    table: 'kline_etcusdt',
                }
            });
