define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'kline/ltcusdt/index' + location.search,
                    add_url: 'kline/ltcusdt/add',
                    edit_url: 'kline/ltcusdt/edit',
                    del_url: 'kline/ltcusdt/del',
                    multi_url: 'kline/ltcusdt/multi',
                    import_url: 'kline/ltcusdt/import',
                    table: 'kline_ltcusdt',
                }
            });
