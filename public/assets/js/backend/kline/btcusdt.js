define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'kline/btcusdt/index' + location.search,
                    add_url: 'kline/btcusdt/add',
                    edit_url: 'kline/btcusdt/edit',
                    del_url: 'kline/btcusdt/del',
                    multi_url: 'kline/btcusdt/multi',
                    import_url: 'kline/btcusdt/import',
                    table: 'kline_btcusdt',
                }
            });
