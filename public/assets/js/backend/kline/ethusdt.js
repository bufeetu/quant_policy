define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'kline/ethusdt/index' + location.search,
                    add_url: 'kline/ethusdt/add',
                    edit_url: 'kline/ethusdt/edit',
                    del_url: 'kline/ethusdt/del',
                    multi_url: 'kline/ethusdt/multi',
                    import_url: 'kline/ethusdt/import',
                    table: 'kline_ethusdt',
                }
            });
